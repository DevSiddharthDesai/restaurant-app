...
enum ErrorType {
  ...
  export abstract class ApiError extends Error {
    constructor(public type: ErrorType, public message: string = 'error', public httpStatusCode: number) {
      super(type);
    }
  }
  ...
  export class UnprocessableEntityError extends ApiError {
    constructor(message = 'File size is large') {
      super(ErrorType.UNPROCESSABLE_ENTITY, message, ResponseStatus.UNPROCESSABLE_ENTITY);
    }
  }
  export class UnsupportedMediaFile extends ApiError {
    constructor(message = 'Unsupported Media Type') {
      super(ErrorType.UNSUPPORTED_MEDIA_FILE, message, ResponseStatus.UNSUPPORTED_MEDIA_FILE);
    }
  }
