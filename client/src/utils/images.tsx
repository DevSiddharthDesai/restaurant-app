import I1 from '../assets/images/Arcadian.jpg';
...
import Menus from '../assets/images/menu-cc.png';
import Reviews from '../assets/images/common.png';
import Info from '../assets/images/info-x.png';

export { I1, P1, P2, P3, P4, P5, P6, P7, Burger, Menus, Reviews, Info };
